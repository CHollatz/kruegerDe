...
const App = () => {
    ...
    return (<div className='relative' style={{ cursor: isCustomCursor ? `url(${mouse}) ,default` : '', }}>
        <Element name="navbar">
            <Navbar />
        </Element>
        <Element name="header">
        ...
        <button className='fixed bottom-0 right-0 h-10 w-10 rounded-lg m-8 border border-blue-400 bg-gray-800 text-gray-200' onClick={() => scroll.scrollToTop()}><ArrowUpwardIcon /></button>
    </div>)
}
